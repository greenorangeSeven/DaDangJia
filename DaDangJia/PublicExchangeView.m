...
@implementation PublicExchangeView
...
- (IBAction)submitAction:(id)sender {
    ...
    ExChange *e = [[ExChange alloc] init];
    e.teme = titleStr;
    e.phone = telNumStr;
    e.connect = contentStr;
    NSData *jsonData = [Tool getJSON:e options:NSJSONWritingPrettyPrinted error:nil];
