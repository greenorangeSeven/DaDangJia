...
- (void)nextAction:(id)sender
{
    ...
    step3View.mobileNoStr = self.mobileNoStr;
    step3View.validateCodeStr = self.validateCodeStr;
    step3View.passwordStr = self.passwordStr;
    step3View.nickName = nickNameStr;
    step3View.numberId = houseNumId;
