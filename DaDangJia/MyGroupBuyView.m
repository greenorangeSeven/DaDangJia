...
- (void)reload:(BOOL)noRefresh
{
    ...
    if ([UserModel Instance].isNetworkRunning) {
        ...
        NSString *findGroupBuyingInfoByUserIdUrl = [Tool serializeURL:[NSString stringWithFormat:@"%@%@", api_base_url, api_findGroupBuyingInfoByUserId] params:param];
        [[AFOSCClient sharedClient]getPath:findGroupBuyingInfoByUserIdUrl parameters:Nil
